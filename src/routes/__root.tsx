...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "חיפוש ישיבות בישראל — מצאו ישיבה לבנים ולבנות" },
      { property: "og:description", content: "רשימה מקיפה של כל הישיבות בישראל - חב\"ד, ליטאי, ירושלמי, ספרדי ועוד. חיפוש לפי מגדר, סוג ועיר." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "חיפוש ישיבות בישראל — מצאו ישיבה לבנים ולבנות" },
      { name: "twitter:description", content: "רשימה מקיפה של כל הישיבות בישראל - חב\"ד, ליטאי, ירושלמי, ספרדי ועוד. חיפוש לפי מגדר, סוג ועיר." },
